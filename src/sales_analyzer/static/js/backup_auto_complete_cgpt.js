...
function insertLabeled(label, value) {
  ...
  (function territoryStrategy() {
    ...
    $ta.textcomplete([{
      ...
      replace: function (item) {
        // return specialReplace('Territory', item.text);
  ...
  (function szoneStrategy() {
    ...
    $ta.textcomplete([{
      ...
      replace: function (item) {
        // return specialReplace('Sales Zone', item.text);
  ...
  (function matklStrategy() {
    ...
    $ta.textcomplete([{
      ...
      replace: function (item) {
        // return specialReplace('Material Group', item.text);
  ...
  (function divisionStrategy() {
    ...
    $ta.textcomplete([{
     ...
     replace: function (item) {
          ...
          // Insert our computed result manually
          $input.val(result).trigger('input');

          // Hide dropdown & stop further insertion
          $input.trigger('textComplete:hide');
      },
    ...
    $ta.textcomplete([{
      ...
      replace: function (item) {
        // return specialReplace('Division Code', item.text);

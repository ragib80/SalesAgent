...
#     # For performance & UX
#     verbose_name = "Depo assignment"
#     verbose_name_plural = "Depo assignments"
#     classes = ['collapse']
class UserDepoInline(admin.TabularInline):
    model = UserDepoMap
    ...
    # If you added unique constraint (user,depo), admin prevents dupes.

# class UserZoneInline(admin.TabularInline):
#     model = UserZoneMap
#     extra = 0
#     autocomplete_fields = ['zone']
#     verbose_name = "Zone assignment"
#     verbose_name_plural = "Zone assignments"
#     classes = ['collapse']
